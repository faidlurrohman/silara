...
import { REKENING_JENIS_TMP } from "../../helpers/constants";
  ...
  return (
    <>
      <div className="flex flex-row space-x-2">
        <CSVLink
          data={REKENING_JENIS_TMP.map(
            ({ group, label, remark, isActive }) => ({
              group,
              label,
              remark,
          ...
          headers={[
            { label: "Kelompok Rekening", key: "group" },
      ...
      <div className="mt-4">
        <Table dataSource={REKENING_JENIS_TMP} columns={columns} />
      </div>
      <Modal
        centered
        open={isShow}
        title={`${isEdit ? `Ubah` : `Tambah`} Rekening Jenis`}
      ...
      >
        ...
        >
          ...
          <Form.Item label="Kelompok Rekening" name="group">
            <Select />
          </Form.Item>
