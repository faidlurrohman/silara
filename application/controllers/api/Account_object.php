...
class Account_object extends REST_Controller {
    ...
    {   
        $data = $this->Account_object_model->get_all();
    ...
    {   
        $data = $this->Account_object_model->get_list();
    ...
    {
        $data = $this->Account_object_model->save($this->input_fields());
    ...
    private function do_delete($id)
    {
        ...
        $data = $this->Account_object_model->delete(array('id' => $id));
