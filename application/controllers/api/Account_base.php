...
class Account_base extends REST_Controller {
    ...
    {   
        ...
        if($user){
            $data = $this->Account_base_model->get_list($user);
    ...
    private function do_create()
    {
        ...
        if($user){
            $data = $this->Account_base_model->save($user, $this->input_fields());
    ...
    private function do_delete($id)
    {
        ...
        if($user){
            $data = $this->Account_base_model->delete($user, array('id' => $id));
